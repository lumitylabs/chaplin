...
function Navbar() {
      ...
      <div className="flex gap-3">
        ...
        */}
        <a
          ...
          className="flex w-25 py-2 px-5 border-[#303136] border rounded-full text-white text-[0.92em] justify-center items-center cursor-pointer transition-colors duration-200 hover:bg-[#1F1F23]"
        >
          Discord
        </a>
  ...
  target="_blank"
  rel="noopener noreferrer"
  className="flex w-30 py-2 px-5 bg-white text-black text-[0.92em] rounded-full justify-center items-center gap-2 cursor-pointer transition-colors duration-200 hover:bg-[#E3E3E4]"
>
  <svg
